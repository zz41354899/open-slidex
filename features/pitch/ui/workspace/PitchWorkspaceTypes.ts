...
export type PitchWorkspaceCommands = {
  ...
  reorderMotionActions: (sourceActionId: string, targetActionId: string) => void;
  setSharedMorphLink: (sourceBlockIndex: number, targetBlockIndex: number | null, sourceSlideIndex?: number) => void;
