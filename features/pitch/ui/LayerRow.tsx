  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 truncate">
        ...
        <span className={`truncate text-[14px] font-medium transition-colors ${isSelected ? "text-white" : "text-neutral-300 group-hover:text-white"}`}>{blockLayerLabel(block)}</span>
