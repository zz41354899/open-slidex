...
export function PreviewCanvas({
  ...
  function startRotate(event: PointerEvent<HTMLSpanElement>, blockIndex: number, frame: MotionDocFrame) {
            ...
            return (
              ...
              >
                <div className="hidden h-6 items-center justify-between px-1 font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-neutral-500 sm:flex">
                  <span className={isActiveSlideFrame ? "text-[#8ea5ff]" : undefined}>{locale === "zh-TW" ? `投影片 ${slide.index + 1}` : `Slide ${slide.index + 1}`}</span>
