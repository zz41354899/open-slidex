...
export function CanvasBlockDock({
  ...
  function selectShapeTool(type: AddBlockType, options?: AddBlockOptions) {
    if (type !== "ShapeRectangle") return;
  ...
  return (
    <>
      ...
      {activeGroup?.id === "shape" ? (
        <ShapeLibraryModal onAddTool={selectShapeTool} onClose={() => setOpenGroupId(null)} />
      ) : null}
