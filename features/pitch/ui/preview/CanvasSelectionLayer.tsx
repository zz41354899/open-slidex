...
type CanvasSelectionLayerProps = {
  ...
  onStartRotate: (event: PointerEvent<HTMLSpanElement>, blockIndex: number, frame: MotionDocFrame) => void;
  ...
  return (
    ...
    >
      ...
      {activeSlide?.blocks.map((block, blockIndex) => {
        ...
        const isVisualBlock = block.type === "Icon" || block.type === "ImageBlock" || block.type === "VideoBlock" || isShapeImage;
