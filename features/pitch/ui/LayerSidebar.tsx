...
import { Bot, ChevronRight, Group, Layers, Plus, Trash2 } from "lucide-react";
                          ...
                          return (
                            <div className={`overflow-hidden rounded-xl border transition-colors ${isGroupSelected ? "border-[#8ea5ff]/45 bg-[#8ea5ff]/[0.08]" : "border-white/[0.07] bg-white/[0.018]"}`} key={entry.id}>
                              <div
                                ...
                                className="flex h-10 cursor-pointer items-center gap-2 border-b border-white/[0.06] px-3 text-[12px] font-semibold text-neutral-300 outline-none transition-colors hover:bg-white/[0.05] focus-visible:ring-2 focus-visible:ring-[#8ea5ff]/65"
                              ...
                              >
                                ...
                                <span className="font-mono text-[10px] text-neutral-500">{entry.layers.length}</span>
                              </div>
