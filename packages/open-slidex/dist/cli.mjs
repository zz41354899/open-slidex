...
`);return}if(e==="help"||e==="--help"||e==="-h"){process.stdout.write(v());return}let t=g(e),s=t==="create"||t==="mcp"?n:[e,...n];await h(m(t),s)}function g(e){if(e==="init")return"create";if(e==="mcp")return"mcp";if(["workspace","dev","build","preview","sync:skills"].includes(e))return"workbench";if(["validate","render","export"].includes(e))return"sdk";throw new Error(`Unknown command: ${e}. Run open-slidex --help.`)}function m(e){let n={create:"dist/create.mjs",mcp:"runtime/mcp/server.mjs",sdk:"runtime/sdk/cli.js",workbench:"runtime/workbench/cli.mjs"};return i.join(c,n[e])}function h(e,n){return new Promise((t,s)=>{let o=x(process.execPath,[e,...n],{cwd:process.cwd(),env:{...process.env,...e===m("workbench")?{OPEN_SLIDEX_TEMPLATE_ROOT:i.join(c,"template")}:{}},stdio:"inherit"}),p=r=>{o.exitCode===null&&o.signalCode===null&&o.kill(r)},d=()=>p("SIGINT"),a=()=>p("SIGTERM"),l=()=>{process.off("SIGINT",d),process.off("SIGTERM",a)};process.once("SIGINT",d),process.once("SIGTERM",a),o.once("error",r=>{l(),s(r)}),o.once("exit",(r,u)=>{l(),r===0||u==="SIGINT"||u==="SIGTERM"?t():s(new Error(`open-slidex ${n[0]??""} exited with code ${r??"unknown"}.`))})})}function v(){return`OpenSlideX
