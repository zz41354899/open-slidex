...
/** Browser-like canvas zoom: Cmd/Ctrl + wheel leaves ordinary scrolling intact. */
export function isModifierCanvasZoomEvent(event: { ctrlKey: boolean; metaKey: boolean }) {
