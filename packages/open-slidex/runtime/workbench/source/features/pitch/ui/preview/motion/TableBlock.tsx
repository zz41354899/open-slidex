...
export function TableBlock({
  ...
  return (
    <MotionBlock
      className="w-full max-w-3xl overflow-hidden rounded-xl border backdrop-blur"
      fillFrame={fillFrame}
      radius={props.radius}
      style={rootStyle}
      {...animation}
