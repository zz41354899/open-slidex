...
function InlineTextSegment({
  ...
  const style = {
    ...
    fontSize: segment.fontSize === undefined ? undefined : `${motionDocFontPointsToCanvasPixels(segment.fontSize)}px`,
    fontStyle: segment.italic === undefined ? undefined : segment.italic ? "italic" : "normal",
    fontWeight: segment.fontWeight,
    letterSpacing: segment.letterSpacing === undefined ? undefined : `${motionDocFontPointsToCanvasPixels(segment.letterSpacing)}px`,
    textDecoration: segment.underline === undefined ? undefined : segment.underline ? "underline" : "none"
  } as const;
