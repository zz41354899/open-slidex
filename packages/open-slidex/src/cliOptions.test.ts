...
test("CLI exposes help and version actions without creating a project", () => {
  ...
  assert.match(createSlideXHelp(), /npx open-slidex@0\.3\.1 init my-deck/);
  assert.match(createSlideXHelp(), /pnpm dlx open-slidex@0\.3\.1 init my-deck/);
  assert.match(createSlideXHelp(), /bunx open-slidex@0\.3\.1 init my-deck/);
