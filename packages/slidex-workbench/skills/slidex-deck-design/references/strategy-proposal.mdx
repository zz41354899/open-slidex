...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Text id="strategy-proposal-01-title" role="title" x={54} y={31} w={39} h={29} color="#10212D" fontFamily="Inter" fontSize={39} fontWeight={790} lineHeight={1.0} enter="rise">Lead with the decision the audience must make.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Text id="strategy-proposal-04-label" x={54} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9} fontWeight={760} letterSpacing={1.4}>04 · CONTEXT</Text>
  <Text id="strategy-proposal-04-title" role="title" x={54} y={33} w={39} h={28} color="#10212D" fontFamily="Inter" fontSize={30} fontWeight={780} lineHeight={1.05} enter="rise">Define scope, constraints, and decision rights.</Text>
  <Text id="strategy-proposal-04-body" x={54} y={69} w={36} h={14} color="#596B76" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Use imagery for evidence, setting, emotion, or memory—not decoration.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-05-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Chart id="strategy-proposal-06-chart" type="line" x={7} y={42} w={59} h={40} data='[{"label":"A","value":42},{"label":"B","value":57},{"label":"C","value":49},{"label":"D","value":68}]' palette="ocean" showAxes="true" showLabels="true" ariaLabel="Illustrative chart; replace with verified data" chartMotion="draw" enter="fadeUp" />
  <Text id="strategy-proposal-06-insight" x={73} y={45} w={18} h={22} color="#10212D" fontFamily="Inter" fontSize={16} fontWeight={720} lineHeight={1.25}>Put the conclusion beside the evidence.</Text>
  <Text id="strategy-proposal-06-source" x={73} y={72} w={18} h={9} color="#596B76" fontFamily="Inter" fontSize={8.5} lineHeight={1.4}>ILLUSTRATIVE · replace unit, period, source, and status.</Text>
</Slide>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Chart id="strategy-proposal-09-chart" type="donut" x={7} y={42} w={59} h={40} data='[{"label":"A","value":42},{"label":"B","value":57},{"label":"C","value":49},{"label":"D","value":68}]' palette="ocean" showAxes="true" showLabels="true" ariaLabel="Illustrative chart; replace with verified data" chartMotion="sweep" enter="fadeUp" />
  <Text id="strategy-proposal-09-insight" x={73} y={45} w={18} h={22} color="#10212D" fontFamily="Inter" fontSize={16} fontWeight={720} lineHeight={1.25}>Put the conclusion beside the evidence.</Text>
  <Text id="strategy-proposal-09-source" x={73} y={72} w={18} h={9} color="#596B76" fontFamily="Inter" fontSize={8.5} lineHeight={1.4}>ILLUSTRATIVE · replace unit, period, source, and status.</Text>
</Slide>

<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  <ImageBlock id="strategy-proposal-10-image" src="https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=1600&auto=format&fit=crop&q=82" alt="Verified Unsplash contextual photograph for slide 10" fit="cover" x={0} y={0} w={45} h={100} radius={0} enter="fadeIn" />
  <Text id="strategy-proposal-10-label" x={54} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9} fontWeight={760} letterSpacing={1.4}>10 · CONTEXT</Text>
  <Text id="strategy-proposal-10-title" role="title" x={54} y={33} w={39} h={28} color="#10212D" fontFamily="Inter" fontSize={30} fontWeight={780} lineHeight={1.05} enter="rise">Ground strategy in operating reality.</Text>
  <Text id="strategy-proposal-10-body" x={54} y={69} w={36} h={14} color="#596B76" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Use imagery for evidence, setting, emotion, or memory—not decoration.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-11-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Chart id="strategy-proposal-14-chart" type="line" x={7} y={42} w={59} h={40} data='[{"label":"A","value":42},{"label":"B","value":57},{"label":"C","value":49},{"label":"D","value":68}]' palette="ocean" showAxes="true" showLabels="true" ariaLabel="Illustrative chart; replace with verified data" chartMotion="draw" enter="fadeUp" />
  <Text id="strategy-proposal-14-insight" x={73} y={45} w={18} h={22} color="#10212D" fontFamily="Inter" fontSize={16} fontWeight={720} lineHeight={1.25}>Put the conclusion beside the evidence.</Text>
  <Text id="strategy-proposal-14-source" x={73} y={72} w={18} h={9} color="#596B76" fontFamily="Inter" fontSize={8.5} lineHeight={1.4}>ILLUSTRATIVE · replace unit, period, source, and status.</Text>
</Slide>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-15-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  <ImageBlock id="strategy-proposal-16-image" src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=1600&auto=format&fit=crop&q=82" alt="Verified Unsplash contextual photograph for slide 16" fit="cover" x={0} y={0} w={45} h={100} radius={0} enter="fadeIn" />
  <Text id="strategy-proposal-16-label" x={54} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9} fontWeight={760} letterSpacing={1.4}>16 · CONTEXT</Text>
  <Text id="strategy-proposal-16-title" role="title" x={54} y={33} w={39} h={28} color="#10212D" fontFamily="Inter" fontSize={30} fontWeight={780} lineHeight={1.05} enter="rise">A real operating scene makes abstraction testable.</Text>
  <Text id="strategy-proposal-16-body" x={54} y={69} w={36} h={14} color="#596B76" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Use imagery for evidence, setting, emotion, or memory—not decoration.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Chart id="strategy-proposal-18-chart" type="bar" x={7} y={42} w={59} h={40} data='[{"label":"A","value":42},{"label":"B","value":57},{"label":"C","value":49},{"label":"D","value":68}]' palette="ocean" showAxes="true" showLabels="true" ariaLabel="Illustrative chart; replace with verified data" chartMotion="grow" enter="fadeUp" />
  <Text id="strategy-proposal-18-insight" x={73} y={45} w={18} h={22} color="#10212D" fontFamily="Inter" fontSize={16} fontWeight={720} lineHeight={1.25}>Put the conclusion beside the evidence.</Text>
  <Text id="strategy-proposal-18-source" x={73} y={72} w={18} h={9} color="#596B76" fontFamily="Inter" fontSize={8.5} lineHeight={1.4}>ILLUSTRATIVE · replace unit, period, source, and status.</Text>
</Slide>

<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  <ImageBlock id="strategy-proposal-19-image" src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=1600&auto=format&fit=crop&q=82" alt="Verified Unsplash contextual photograph for slide 19" fit="cover" x={55} y={0} w={45} h={100} radius={0} enter="fadeIn" />
  <Text id="strategy-proposal-19-label" x={7} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9} fontWeight={760} letterSpacing={1.4}>19 · CONTEXT</Text>
  <Text id="strategy-proposal-19-title" role="title" x={7} y={33} w={39} h={28} color="#10212D" fontFamily="Inter" fontSize={30} fontWeight={780} lineHeight={1.05} enter="rise">A bounded pilot can make a claim testable.</Text>
  <Text id="strategy-proposal-19-body" x={7} y={69} w={36} h={14} color="#596B76" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Use imagery for evidence, setting, emotion, or memory—not decoration.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-22-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#0B1E2D" theme="dark" slideTransition="fade">
  ...
  <Table id="strategy-proposal-23-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#F7FBFC" background="#0B1E2D" cellBackground="#17313A" stripeBackground="#102731" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-24-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  <ImageBlock id="strategy-proposal-25-image" src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=1600&auto=format&fit=crop&q=82" alt="Verified Unsplash contextual photograph for slide 25" fit="cover" x={55} y={0} w={45} h={100} radius={0} enter="fadeIn" />
  <Text id="strategy-proposal-25-label" x={7} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9} fontWeight={760} letterSpacing={1.4}>25 · CONTEXT</Text>
  <Text id="strategy-proposal-25-title" role="title" x={7} y={33} w={39} h={28} color="#10212D" fontFamily="Inter" fontSize={30} fontWeight={780} lineHeight={1.05} enter="rise">Recommend one option with an explicit boundary.</Text>
  <Text id="strategy-proposal-25-body" x={7} y={69} w={36} h={14} color="#596B76" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Use imagery for evidence, setting, emotion, or memory—not decoration.</Text>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-26-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-27-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Chart id="strategy-proposal-28-chart" type="area" x={7} y={42} w={59} h={40} data='[{"label":"A","value":42},{"label":"B","value":57},{"label":"C","value":49},{"label":"D","value":68}]' palette="ocean" showAxes="true" showLabels="true" ariaLabel="Illustrative chart; replace with verified data" chartMotion="draw" enter="fadeUp" />
  <Text id="strategy-proposal-28-insight" x={73} y={45} w={18} h={22} color="#10212D" fontFamily="Inter" fontSize={16} fontWeight={720} lineHeight={1.25}>Put the conclusion beside the evidence.</Text>
  <Text id="strategy-proposal-28-source" x={73} y={72} w={18} h={9} color="#596B76" fontFamily="Inter" fontSize={8.5} lineHeight={1.4}>ILLUSTRATIVE · replace unit, period, source, and status.</Text>
</Slide>
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#F8FAFB" theme="light" slideTransition="fade">
  ...
  <Table id="strategy-proposal-29-table" x={7} y={42} w={86} h={36} rows={4} columns={4} cells="Item|Evidence|Implication|Owner;Primary|Illustrative|Replace with source|Named;Secondary|Illustrative|Replace with source|Named;Boundary|Illustrative|State limitation|Named" fontSize={10} fontWeight={520} color="#10212D" background="#F8FAFB" cellBackground="#E7F2F7" stripeBackground="#F8FAFB" borderColor="#2587B5" borderWidth={1} enter="fadeUp" />
...
<Slide duration={7} canvasWidth={1920} canvasHeight={1080} fontSizeUnit="pt" background="#0B1E2D" theme="dark" slideTransition="fade">
  <ImageBlock id="strategy-proposal-30-image" src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=1600&auto=format&fit=crop&q=82" alt="Verified Unsplash closing photograph for Strategy Proposal" fit="cover" x={0} y={0} w={45} h={100} radius={0} enter="fadeIn" />
  <Text id="strategy-proposal-30-label" x={54} y={13} w={39} h={6} color="#2587B5" fontFamily="Inter" fontSize={9.5} fontWeight={760} letterSpacing={1.5}>30 · CLOSE</Text>
  <Text id="strategy-proposal-30-title" role="title" x={54} y={34} w={39} h={27} color="#F7FBFC" fontFamily="Inter" fontSize={34} fontWeight={790} lineHeight={1.04} enter="rise">Approve the next reversible step.</Text>
  <Text id="strategy-proposal-30-body" x={54} y={69} w={36} h={14} color="#C4CFD2" fontFamily="Inter" fontSize={11.5} lineHeight={1.45}>Replace the teaching copy with the real commitment, owner, evidence, and next review date.</Text>
