...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#38BDF8" accent="#0A84FF" textColor="#FFFFFF" mutedColor="#DFF6FF" canvasHeight={1080} canvasWidth={1920} slideTransition="fade" transitionDuration={0.7} shader="mesh-gradient" shaderEngine="three" shaderPreset="Beach" shaderFrame={1200} shaderSpeed={0.1} shaderScale={1} shaderIntensity={0.8} shaderSoftness={0.35} shaderDetail={0} shaderAngle={0} shaderColor1="#BCECF6" shaderColor2="#00AAFF" shaderColor3="#00F7FF" shaderColor4="#FFD447" shaderColor5="#BCECF6" shaderColor6="#FFFFFF">
  <Shape id="cover-halo" shape="circle" fill="#7DD3FC" stroke="transparent" strokeWidth={0} x={74} y={0} w={26} h={46} enter="zoomIn" delay={0.1} radius={16} />
  <Shape id="cover-star" shape="star" fill="#4D81D2" stroke="transparent" strokeWidth={0} x={4.8} y={28} w={19} h={33} points={5} rotation={-20} enter="pop" delay={0.18} radius={16} />
  <Shape id="cover-sun" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={88.6} y={7} w={7.2} h={12.8} enter="zoomIn" delay={0.26} radius={16} />
  <Text id="cover-kicker" x={7} y={11} w={52} h={6} color="#FFFFFF" fontFamily="Arial" fontWeight={700} fontSize={15} letterSpacing={0.5} enter="fadeIn" delay={0.08}>SUMMER 2026 | SUMMIT | TOOLKIT</Text>
  <Text id="cover-title-line-one" x={7} y={48} w={72} h={14} color="#FFFFFF" fontFamily="Arial" fontWeight={700} fontSize={68} lineHeight={1} enter="rise" delay={0.16}>Summer Time</Text>
  <Text id="cover-title-line-two" x={7} y={65} w={48} h={14} color="#FFFFFF" fontFamily="Arial" fontWeight={700} fontSize={68} lineHeight={1} enter="rise" delay={0.26}>Report</Text>
  <Text id="cover-caption" x={7} y={84} w={55} h={6} color="#E0F7FF" fontFamily="Arial" fontWeight={400} fontSize={18} lineHeight={1.2} enter="fadeUp" delay={0.38}>A clear recap of what moved the season forward.</Text>
</Slide>
...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#F2FAFF" accent="#0A84FF" textColor="#223E53" mutedColor="#656565" canvasHeight={1080} canvasWidth={1920} slideTransition="pushLeft" transitionDuration={0.7}>
  ...
  <Shape id="about-panel" shape="rectangle" fill="#FFFFFF" stroke="#D7E9F2" strokeWidth={1.5} x={63} y={17} w={27} h={58} radius={28} enter="fadeIn" delay={0.2} />
  <Shape id="about-orbit-one" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={69} y={25} w={9} h={16} />
  <Shape id="about-orbit-two" shape="circle" fill="#4D81D2" stroke="transparent" strokeWidth={0} x={77} y={42} w={6} h={10.7} />
  <Shape id="about-star" shape="star" fill="#38BDF8" stroke="transparent" strokeWidth={0} x={68.2} y={53} w={13} h={22} points={5} rotation={16} />
...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#FFFFFF" accent="#0A84FF" textColor="#223E53" mutedColor="#656565" canvasHeight={1080} canvasWidth={1920} slideTransition="fade" transitionDuration={0.7}>
  ...
  <Shape id="highlight-kickoff-icon" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={9} y={42} w={4.5} h={8} enter="pop" delay={0.26} />
  ...
  <Shape id="highlight-community-icon" shape="circle" fill="#4D81D2" stroke="transparent" strokeWidth={0} x={39.4} y={42} w={4.5} h={8} enter="pop" delay={0.36} />
  ...
  <Shape id="highlight-standout-surface" shape="rectangle" fill="#F2FAFF" stroke="#D7E9F2" strokeWidth={1.2} x={67.4} y={37} w={26} h={49} radius={20} enter="fadeUp" delay={0.38} />
  <Shape id="highlight-standout-icon" shape="star" fill="#38BDF8" stroke="transparent" strokeWidth={0} x={69.5} y={41.5} w={5.2} h={9.2} points={5} rotation={12} enter="pop" delay={0.46} />
  ...
  <Shape id="highlights-sun" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={89} y={6.5} w={6.9} h={12.2} />
</Slide>
...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#F2FAFF" accent="#0A84FF" textColor="#223E53" mutedColor="#656565" canvasHeight={1080} canvasWidth={1920} slideTransition="fade" transitionDuration={0.7}>
  ...
  <Chart ariaLabel="Quarterly performance" chartMotion="auto" data="[{&quot;label&quot;:&quot;Q1&quot;,&quot;value&quot;:42},{&quot;label&quot;:&quot;Q2&quot;,&quot;value&quot;:58},{&quot;label&quot;:&quot;Q3&quot;,&quot;value&quot;:73},{&quot;label&quot;:&quot;Q4&quot;,&quot;value&quot;:91}]" enter="fadeUp" h={52} palette="aurora" showAxes="true" showLabels="true" type="bar" w={78} x={11} y={25} id="block-1a09516b-92af-4ba4-bf62-ca6afa633a51" radius={0} />
</Slide>
...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#FFFFFF" accent="#0A84FF" textColor="#223E53" mutedColor="#656565" canvasHeight={1080} canvasWidth={1920} slideTransition="pushLeft" transitionDuration={0.7}>
  ...
  <Shape id="timeline-line" shape="line" fill="transparent" stroke="#D8DEE3" strokeWidth={2} x={6.6} y={52} w={86.8} h={0.4} enter="reveal" delay={0.12} />
  ...
  <Shape id="timeline-kickoff-dot" shape="circle" fill="#0A84FF" stroke="transparent" strokeWidth={0} x={13.3} y={50.8} w={1.35} h={2.4} />
  ...
  <Shape id="timeline-build-dot" shape="circle" fill="#0A84FF" stroke="transparent" strokeWidth={0} x={35.3} y={50.8} w={1.35} h={2.4} />
  ...
  <Shape id="timeline-peak-dot" shape="circle" fill="#0A84FF" stroke="transparent" strokeWidth={0} x={57.3} y={50.8} w={1.35} h={2.4} />
  ...
  <Shape id="timeline-wrap-dot" shape="circle" fill="#0A84FF" stroke="transparent" strokeWidth={0} x={79.3} y={50.8} w={1.35} h={2.4} />
  <Shape id="timeline-sun" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={92.3} y={6.5} w={5} h={8.9} />
</Slide>
...
<Slide duration={5} fontSizeUnit="pt" theme="dark" background="#0A2540" accent="#FFBC90" textColor="#FFFFFF" mutedColor="#B9CAD8" canvasHeight={1080} canvasWidth={1920} slideTransition="rise" transitionDuration={0.7}>
  ...
  <Shape id="next-rule" shape="line" fill="transparent" stroke="#315570" strokeWidth={1.2} x={6.6} y={33} w={64} h={0.3} />
  <Shape id="next-one-dot" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={6.6} y={42} w={1.35} h={2.4} />
  ...
  <Shape id="next-two-dot" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={6.6} y={54} w={1.35} h={2.4} />
  ...
  <Shape id="next-three-dot" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={6.6} y={66} w={1.35} h={2.4} />
  ...
  <Shape id="next-four-dot" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={6.6} y={78} w={1.35} h={2.4} />
...
<Slide duration={5} fontSizeUnit="pt" theme="light" background="#38BDF8" accent="#0A84FF" textColor="#FFFFFF" mutedColor="#DFF6FF" canvasHeight={1080} canvasWidth={1920} slideTransition="fade" transitionDuration={0.7} shader="mesh-gradient" shaderEngine="three" shaderPreset="Beach" shaderFrame={2400} shaderSpeed={0.1} shaderScale={1} shaderIntensity={0.8} shaderSoftness={0.35} shaderDetail={0} shaderAngle={0} shaderColor1="#BCECF6" shaderColor2="#00AAFF" shaderColor3="#00F7FF" shaderColor4="#FFD447" shaderColor5="#BCECF6" shaderColor6="#FFFFFF">
  <Shape id="thanks-halo" shape="circle" fill="#7DD3FC" stroke="transparent" strokeWidth={0} x={0} y={54} w={24} h={42} />
  <Shape id="thanks-star" shape="star" fill="#4D81D2" stroke="transparent" strokeWidth={0} x={76} y={25} w={19} h={33} points={5} rotation={20} />
  <Shape id="thanks-sun" shape="circle" fill="#FFBC90" stroke="transparent" strokeWidth={0} x={88.6} y={7} w={7.2} h={12.8} />
  <Text id="thanks-kicker" x={7} y={11} w={58} h={6} color="#FFFFFF" fontFamily="Arial" fontWeight={700} fontSize={15} letterSpacing={0.5} enter="fadeIn">QUESTIONS | FEEDBACK | NEXT SEASON</Text>
  <Text id="thanks-title" x={7} y={50} w={56} h={15} color="#FFFFFF" fontFamily="Arial" fontWeight={700} fontSize={72} lineHeight={1} enter="rise" delay={0.12}>Thank You</Text>
  <Text id="thanks-caption" x={7} y={76} w={56} h={7} color="#E0F7FF" fontFamily="Arial" fontWeight={400} fontSize={18} lineHeight={1.2} enter="fadeUp" delay={0.24}>Let's carry the strongest signals into the season ahead.</Text>
</Slide>
